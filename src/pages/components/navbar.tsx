  ...
  return (
    <nav className="container w-50 m-auto flex">
      ...
      >
        ...
        <FontAwesomeIcon icon={faCaretDown} size="1x" className="ml-3" />
      </div>
      <div
        id="divider"
        className="ml-4 border-2 border-navdivider opacity-25 h-12 mt-nav-height NAVCLOSED"
        ...
        <ul className="flex flex-row hover:drop-shadow-[0_35px_35px_rgba(89, 216, 255)]">
          ...
          <li className="text-navtext font-bold mt-nav-text-height">
            <Link href="https://twitter.com">
              <FontAwesomeIcon icon={faTwitter} size="1x" className="ml-3" />
            </Link>
          </li>
          <li className="text-navtext font-bold mt-nav-text-height">
            <Link href="https://github.com">
              <FontAwesomeIcon icon={faGithub} size="1x" className="ml-3" />
            </Link>
          </li>
        </ul>
      </div>
